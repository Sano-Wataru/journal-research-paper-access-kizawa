...
\deleted{A diverse set of three-dimensional features is effective for activity level estimation with XGBoost on short video datasets.}
\revised{A diverse set of three-dimensional features achieved the highest accuracy for activity level estimation with XGBoost on short video datasets.}
