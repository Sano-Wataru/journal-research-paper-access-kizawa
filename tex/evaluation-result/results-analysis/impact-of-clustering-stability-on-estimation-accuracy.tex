...
%
\deleted{Section~\ref{subsec:evaluation-short} demonstrated that three-dimensional point-cloud features are effective for activity level estimation.}
\revised{Section~\ref{subsec:evaluation-short} demonstrated that three-dimensional point-cloud features achieved higher accuracy for activity level estimation.}
